var require = {
  ...
  paths: {
    ...
    'cm/lib/codemirror': '//cdnjs.cloudflare.com/ajax/libs/codemirror/5.5.0/codemirror.min',
    'cm/mode/javascript/javascript': '//cdnjs.cloudflare.com/ajax/libs/codemirror/5.5.0/mode/javascript/javascript.min',
